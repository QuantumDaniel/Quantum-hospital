            ...
            <div className="container">
                <div className="row align-items-center  sub ">
                    ...
                    <div className="hero-content  ">
                        ...
                        <h1 className="hero-desc anim-3 bg-secondary px-2 desk d-flex">
                        ...
                        <div className="hero-btns anim-4 btns">
                        ...
                        <div className="hero-stats anim-5 bg-light px-2 stat-text">
                            <div className="sub-stats stat-text">
                                <div><div className="stat-val">{patients}+</div><div className="stat-label text-dark stat-lab">Patients Served</div></div>
                                <div><div className="stat-val">{experts}+</div><div className="stat-label text-dark stat-lab">Medical Experts</div></div>
                                <div><div className="stat-val">10</div><div className="stat-label text-dark">Departments</div></div>
                                <div><div className="stat-val">24/7</div><div className="stat-label text-dark">Emergency Care</div></div>
                            </div>
                        </div>
